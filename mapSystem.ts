 ...
 * background images, and admin tool functionality.
 */
...
/**
 * Enhanced track with points array and visual styling support
 */
...
export interface ValidationError {
  /** Error type/category */
  type: 'station' | 'track' | 'network' | 'background' | 'metadata' | 'structure';
  ...
  /** Error category (alias for type for backward compatibility) */
...
export interface MapValidationResult {
  ...
  /** Warning messages (string array for backward compatibility) */
  warnings?: string[];
